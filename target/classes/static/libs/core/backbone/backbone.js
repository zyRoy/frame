...
(function(factory) {
  ...
  // an event in another object... keeping track-car of what it's listening to.
  Events.listenTo =  function(obj, name, callback) {
    ...
    // Setup the necessary references to track-car the listening callbacks.
    if (!listening) {
      var thisId = this._listenId || (this._listenId = _.uniqueId('l'));
      listening = listeningTo[id] = {obj: obj, objId: id, id: thisId, listeningTo: listeningTo, count: 0};
    }

    // Bind callbacks on obj, and keep track-car of them on listening.
